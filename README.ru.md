...
- `/greenapi.remove-instance` - Удаление любого инстанса из рабочего пространства
...
Обе роли могут обновлять свои токены аутентификации используя `/greenapi.update-token`.
...
- `rocket-chat-id`: Ваш ID в Rocket.Chat (требуется роль администратора)
...
- Установка командного токена рабочего пространства в настройках приложения
